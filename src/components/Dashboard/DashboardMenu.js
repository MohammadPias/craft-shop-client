...
export const menus = [
    ...
    { name: 'Manage Users', icon: <i className="fa-solid fa-users"></i>, path: 'manageUsers' },
    { name: 'Manage Products', icon: <i className="fa-brands fa-product-hunt"></i>, path: 'manageProducts' },
    { name: 'MY Profile', icon: <i className="fa-solid fa-user-gear"></i>, path: 'myProfile' },
]